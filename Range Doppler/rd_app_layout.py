...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.false_alarm_spin.setRange(0.001, 1.0)
        self.false_alarm_spin.setSingleStep(0.001)
        self.false_alarm_spin.setDecimals(3)  # Set to display 3 decimal places
        self.false_alarm_spin.setValue(0.001)
